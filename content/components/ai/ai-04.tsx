                ...
                >
                  <DropdownMenuGroup className="space-y-1">
                    ...
                    <DropdownMenuItem className="rounded-[calc(1rem-6px)] text-xs">
                      <IconLink className="opacity-60" size={16} />
                      Import from URL
                    </DropdownMenuItem>
                    <DropdownMenuItem className="rounded-[calc(1rem-6px)] text-xs">
                      <IconClipboard className="opacity-60" size={16} />
                      Paste from Clipboard
                    </DropdownMenuItem>
                    <DropdownMenuItem className="rounded-[calc(1rem-6px)] text-xs">
                      <IconTemplate className="opacity-60" size={16} />
                      Use Template
                    </DropdownMenuItem>
                  </DropdownMenuGroup>
                </DropdownMenuContent>
                  ...
                  <DropdownMenuGroup className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <IconSparkles className="opacity-60" size={16} />
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <IconPlayerPlay className="opacity-60" size={16} />
