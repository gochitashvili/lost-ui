        ...
        <div className="px-3 pt-3 pb-2 flex-grow">
          <form onSubmit={handleSubmit}>
            <Textarea
              ...
              className="w-full bg-transparent! p-0 border-0 shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 text-foreground placeholder-muted-foreground resize-none border-none outline-none text-sm min-h-[2.5rem] max-h-[25vh]"
              rows={1}
              onInput={(e) => {
